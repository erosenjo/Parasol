...
def sim_move():
    num_long = randint(5,8)
    max_short_idx = choice([1,3])
    s_slots = 2**randint(6,13)
    l_slots = 2**randint(5,12)
    while s_slots <= l_slots:
        l_slots = 2**randint(5,12)
    return s_slots, l_slots, max_short_idx, num_long
