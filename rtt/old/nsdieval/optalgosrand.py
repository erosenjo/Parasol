...
from interp_simrand import gen_cost
import numpy as np
...
def random_opt(symbolics_opt, opt_info, o):
    ...
    while True:
        ...
        #log_h = int(math.log2(symbolics_opt["H"]))
        #symbolics_opt["T"] = symbolics_opt["LOG_CQ_T"]+log_h-1
    ...
    with open('testing_solsrand.txt','wb') as f:
        pickle.dump(testing_sols,f)
    with open('testing_evalrand.txt','wb') as f:
