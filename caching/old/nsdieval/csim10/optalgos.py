...
def simulated_annealing(symbolics_opt, opt_info, o):
    ...
    # pick random starting sol for sim annealing
    symbolics_opt = get_next_random(symbolics_opt, opt_info["symbolicvals"]["logs"], bounds, structchoice, structinfo)
    ...
    for i in range(opt_info["optparams"]["stop_iter"]-1):   # minus 1 bc counting init cost as iteration
        ...
        diff = (candidate_cost - curr_cost)*100
