...
#     # e.g., ["avg"]
#     cost = o.calc_cost(measurement, "max")
...
# #     counter = 0
# #     while True:
# #         # generate a trace w/ 260 or 500 pkts
...
def main():
    ...
    # while True:
    #     # generate a trace w/ 260 pkts
    #     bits_set, agent.avg_err = send_pkts(500, opt_info, o, sim_process)
    #     print(bits_set, agent.avg_err)
    #     counter += 1
    #     if counter >= 5:
    #         break
