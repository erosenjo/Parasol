...
# NOTE: if we're cleaning one register TOTAL per packet, move clean_counter[0] += 1 to this function (out of update_bits_set)
# for now, we're cleaning one register in EACH row per packet
